  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        icon={GraduationCap}
        title="Learning"
        subtitle="Close skill gaps through focused practice."
        action={
          <button
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-[#263247] rounded-2xl p-4 shadow-xs">
          <div className="text-xs text-slate-500 dark:text-[#94A3B8] font-medium">Active Paths</div>
          <div className="text-2xl font-bold text-slate-900 dark:text-[#F8FAFC] mt-1">{summary.activePaths}</div>
        </div>
        <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-[#263247] rounded-2xl p-4 shadow-xs">
          <div className="text-xs text-slate-500 dark:text-[#94A3B8] font-medium">Completed This Week</div>
          <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 mt-1">{summary.modulesCompletedThisWeek}</div>
        </div>
        <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-[#263247] rounded-2xl p-4 shadow-xs">
        ...
        <div className="bg-white dark:bg-[#111827] border border-slate-200/80 dark:border-[#263247] rounded-2xl p-4 shadow-xs">
          ...
          <div className="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1">{summary.skillsBeingDeveloped}</div>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Create a learning path to close skill gaps through focused practice."
          primaryAction={{
            label: 'New Path',
            onClick: () => setCreateModalOpen(true),
          }}

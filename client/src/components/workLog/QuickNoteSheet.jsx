        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
          ...
          <div className="p-4 sm:p-5 border-t border-slate-100 dark:border-[rgba(148,163,184,0.14)] flex items-center justify-end gap-2.5 bg-slate-50/50 dark:bg-[#111827] pb-[calc(env(safe-area-inset-bottom,0px)+16px)] sm:pb-5 shrink-0">
            ...
            <button
              type="submit"
              disabled={saving}
              className="h-11 px-6 rounded-xl bg-[#2A7A3B] hover:bg-[#22653A] active:scale-98 text-white font-semibold text-xs sm:text-sm flex items-center gap-2 shadow-md shadow-[#2A7A3B]/20 transition disabled:opacity-50"
            >
              {saving ? (
                <>
